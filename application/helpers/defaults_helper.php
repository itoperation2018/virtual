     ...
     {  
         ...
         "children":[  
            ...
            {  
               "name":"salary_tpl",
               "url":"salary_template",
               "permission":"bulk_pdf_exporter",
               "icon":"",
               "id":"child-bulk-pdf-exporter"
            },
            {  
               "name":"hourly_tpl",
               "url":"hourly_template",
            ...
            {  
               ...
               "permission":"goals",
               "icon":"",
               "id":"child-goals-tracking"
            },
            {  
               "name":"employee_salary_list",
               "url":"payroll\/employee_salary",
               "permission":"surveys",
               "icon":"",
               "id":"child-surveys"
            },
            {  
               ...
               "permission":"is_admin",
               "icon":"",
               "id":"child-announcements"
            },
             {  
               "name":"make_payment",
               "url":"payroll\/make_payment",
               "permission":"is_admin",
               "icon":"",
               "id":"child-announcements"
            },
            {  
               ...
               "url":"payroll\/payroll_summary",
               "permission":"is_admin",
               "icon":"",
               "id":"child-database-backup"
            },
            {  
               "name":"advance_salary",
               "url":"payroll\/advance_salary",
               "permission":"is_admin",
               "icon":"",
               "id":"child-activity-log"
            },
            {  
               "name":"provident_fund",
               "url":"payroll\/provident_fund",
               "permission":"is_admin",
               "icon":"",
               "id":"ticket-pipe-log"
            },
      ...
      {  
         ...
         "children":[  
            ...
            {  
               "name":"bulk_pdf_exporter",
               "url":"utilities\/bulk_pdf_exporter",
               "permission":"bulk_pdf_exporter",
               "icon":"",
               "id":"child-bulk-pdf-exporter"
            },
            {  
               "name":"als_calendar_submenu",
               "url":"utilities\/calendar",
               "permission":"",
               "icon":"",
               "id":"child-calendar"
            },
            {  
               "name":"als_goals_tracking",
               "url":"goals",
               "permission":"goals",
               "icon":"",
               "id":"child-goals-tracking"
            ...
            {  
               "name":"als_announcements_submenu",
               "url":"announcements",
               "permission":"is_admin",
               "icon":"",
               "id":"child-announcements"
            ...
            {  
               "name":"als_activity_log_submenu",
               "url":"utilities\/activity_log",
               "permission":"is_admin",
               "icon":"",
               "id":"child-activity-log"
            },
            {  
               "name":"ticket_pipe_log",
               "url":"utilities\/pipe_log",
               "permission":"is_admin",
               "icon":"",
               "id":"ticket-pipe-log"
            }
      ...
      {  
         ...
         "children":[  
            {  
               "name":"als_reports_sales_submenu",
               "url":"reports\/sales",
               "permission":"",
               "icon":"",
               "id":"child-sales"
            ...
            {  
               "name":"als_expenses_vs_income",
               "url":"reports\/expenses_vs_income",
               "permission":"",
               "icon":"",
               "id":"child-expenses-vs-income"
            },
            {  
               "name":"als_reports_leads_submenu",
               "url":"reports\/leads",
               "permission":"",
               "icon":"",
               "id":"child-leads"
            ...
            {  
               "name":"als_kb_articles_submenu",
               "url":"reports\/knowledge_base_articles",
               "permission":"",
               "icon":"",
               "id":"child-kb-articles"
            }
         ]
      }
   ]
