      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
           ...
           <div class="_buttons">
            <a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#add_attend_modal"><?php echo _l('mark_attendance'); ?></a>
...
<?php $this->load->view('admin/timesheet/mark_attendance'); ?>
...
<script>
  $(function(){
    initDataTable('.table-mark-attendance', admin_url+'timesheet/table', [7], [7],'undefined',[0,'ASC']);
