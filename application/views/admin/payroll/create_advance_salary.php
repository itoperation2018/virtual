<div class="modal fade" id="advance_salary_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/payroll/advance_salary_manage',array('id'=>'add_attend')); ?>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                             <?php echo render_input('amount','Amount'); ?>
                        </div> 
