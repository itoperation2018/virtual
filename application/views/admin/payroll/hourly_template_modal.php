<div class="modal fade" id="hourly_template_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/hourly_template/manage',array('id'=>'add_attend')); ?>
...
function manage_attendance(form) {
    ...
    $.post(url, data).done(function (response) {
        ...
        $('#hourly_template_model').modal('hide');
    }).fail(function (data) {
...
function init_item_js() {
    ...
    $("body").on('change', 'select[name="item_select"]', function () {
        ...
        if (itemid != '' && itemid !== 'newitem') {
            ...
            // New item
            $('#hourly_template_model').modal('show');
        }
    });

    // Items modal show action
    $("body").on('show.bs.modal', '#hourly_template_model', function (event) {

        $('.affect-warning').addClass('hide');

        var $itemModal = $('#hourly_template_model');
    ...
    $("body").on("hidden.bs.modal", '#hourly_template_model', function (event) {
